        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepatrmenId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeReviewsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employees_EmployeeReviews_EmployeeReviewsId",
                        column: x => x.EmployeeReviewsId,
                        principalTable: "EmployeeReviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employees_Holidays_HolidayId",
                        column: x => x.HolidayId,
                        principalTable: "Holidays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employees_Mentorships_MentorShipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_EmployeeReviewsId",
                table: "Employees",
                column: "EmployeeReviewsId");

            migrationBuilder.CreateIndex(
                name: "IX_Employees_HolidayId",
                table: "Employees",
                column: "HolidayId");

            migrationBuilder.CreateIndex(
                name: "IX_Employees_MentorShipId",
                table: "Employees",
                column: "MentorShipId");
